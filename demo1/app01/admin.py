...
class EmployeeAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'gender', 'phone', 'birthplace', 'birthdate', 'joindate', 'position')
    list_filter = ('joindate', 'name', 'gender', 'birthplace', 'position')
    search_fields = ('name', 'position', 'gender')
